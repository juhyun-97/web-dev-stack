...
//		}
	...
	public void method2() {
		// 본인의 이름을 입력햇을 때 본인이면 "본인이다", 아니면 "본인이 아니다"출력
		System.out.print("이름입력 > ");
		String name = sc.nextLine();
		
		System.out.println("name : " + System.identityHashCode(name));
		System.out.println("김주현 : " + System.identityHashCode("김주현"));
		
		if(name.equals("김주현")) System.out.println("본인이다");
	 ...
	 * 		조건식1이 참(true)일 때 실행
	 * } else if(조건식2) {
	 * 		조건식2이 거짓(false)이면서 조건식2이 참(true)일 때 실행
	 * } else {
