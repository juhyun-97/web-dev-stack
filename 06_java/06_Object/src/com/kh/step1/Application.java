...
public class Application { // 메인 실행 클래스 (객체 생성 및 테스트)
	 ...
	 * L : LSP(Liskov Substitution Principle) - 리스코프 피환 원칙
	 * I : ISP(Interface Segregation Principle) - 인터헤이스 분리 원칙
	...
	public static void main(String[] args) {
		...
		System.out.println("TV 채널 : " + tv.channer); // 0
		tv.channelUp();
		tv.channelUp();
		tv.channelUp();
		tv.channelDown();
		...
		tv.channelUp();
		tv.channelUp();
		System.out.println("TV 채널 : " + tv.channer); // 3
	}
}
