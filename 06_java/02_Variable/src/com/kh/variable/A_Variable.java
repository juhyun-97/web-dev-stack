...
//		variable.variableTest();
	...
	public void printValue() {
		...
		// 변수 사용하지 않고
		System.out.println(30 * 2 * 3.141592);                    //syso + crtl + space 하면 자동으로 입력됨
	...
	public void variableTest() {
		 ...
		 * - 변수형 : 변수의 이름으로 값을 읽고, 쓰고 지우는 작업을 할 때 사용
		 * 
		 * 변수의 초기화
		 * 
		 * 변수명 = 값;
...
//		bNum = 128; -> 에러 발생! 오버플로우(overflow)
		...
		int iNum = 922337283; // 4byte (기본) 숫자 = int!!
		long lNum = 922337283458L; // 8byte - 숫자 뒤에 L(l)을 입력해야만 쓸수있음
		
		System.out.println(lNum);
		
		// 4. 실수형
		float fNum = 1.2F; // 4byte - 숫자 뒤에 F(f)를 입력
		double dNum = 1.2; // 8byte (기본) 주로 double 많이 씀
