/*
    ...
    오라클에서 제공하는 객체(구조) / 스키마(Schema)
                         : 테이블(TABLE), 뷰(VIEW), 시퀀스(SEQUENCE),
                           인덱스(INDEX), 패키기(PACKAGE), 트리거(TRIGGER),
...
/*
    ...
    *자료형
    1. 문자(CHAR / VARCHAR2) - 반드시 크기를 지정해야 함(몇글자까지?)
...
INSERT INTO MEMBER VALUES(1, 'user01', 'pass01', '윤의진',
    '남', '010-1111-2222', 'aaa@naver.com', '25/06/05');
...
INSERT INTO MEM_NOTNULL VALUES(1, 'user01', 'pass01', '윤의진',
    '남', '010-1111-2222', 'aaa@naver.com', '25/06/05');
...
INSERT INTO MEM_UNIQUE VALUES(1, 'user01', 'pass01', '윤의진',
    '남', '010-1111-2222', 'aaa@naver.com', '25/06/05');
...
INSERT INTO MEM_CHECK VALUES(1, 'user01', 'pass01', '윤의진',
    '남', '010-1111-2222', 'aaa@naver.com', '25/06/05');
...
INSERT INTO MEM_PRI VALUES(MEM_SEQ.NEXTVAL, 'user01', 'pass01', '윤의진',
    '남', '010-1111-2222', 'aaa@naver.com', '25/06/05');
...
(MEM_ID, MEM_PWD, MEM_NAME, GENDER, PHONE, EMAIL, MEM_DATE) 
VALUES('user01', 'pass01', '윤의진',
    '남', '010-1111-2222', 'aaa@naver.com', '25/06/05');
...
(MEM_ID, MEM_PWD, MEM_NAME, GRADE_ID) 
...
SELECT MEM_ID, MEM_NAME, GRADE_CODE
FROM MEM_MEMBER 
...
*/
ALTER TABLE DEPT_COPY
RENAME CONSTRAINT DEPT_PK TO DEPT_ID_PK;
